...
<template>
  <div class="m-main">
    <div class="player">
      <a href="javascript:void(0)" rel="external nofollow" id="js-play">
        <img src="./img-one/开始.png" alt="" id="img1" />
      </a>
      <a href="javascript:void(0)" rel="external nofollow" id="js-pause">
    ...
    <div class="video">
      <video controls autoplay name="media" id="js-video">
        <source src="./mp3/白月光与朱砂痣.mp3" type="video/mp4" />
      </video>
    </div>
  </div>
